...
public interface MigrationAnnotationParser {
  ...
  /**
   * Returns the {@link com.ecovate.database.migration.annotation.Migration} annotation for a given script instance
   *
   * @param scriptInstance the script instance
   * @return {@link com.ecovate.database.migration.annotation.Migration}
   */
