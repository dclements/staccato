...
public class MigrationAnnotationParserImplTest {
  ...
  public void testIsMigrationScript() throws IOException {
    ...
    Class<? extends DynamicLanguageScript> scriptClass = gcl.parseClass(new File("src/test/groovy/TestScript.groovy"));
  ...
  public void testIsNotMigrationScript() throws IOException {
    ...
    GroovyClassLoader gcl = new GroovyClassLoader(this.getClass().getClassLoader());
    @SuppressWarnings("unchecked")
    Class<? extends DynamicLanguageScript> scriptClass = gcl.parseClass(new File("src/test/groovy/BadTestScript.groovy"));
  ...
  public void testGetAnnotationSuccess() throws IOException, IllegalAccessException, InstantiationException {
    ...
    GroovyClassLoader gcl = new GroovyClassLoader(this.getClass().getClassLoader());
    Class scriptClass = gcl.parseClass(new File("src/test/groovy/TestScript.groovy"));
  ...
  public void testGetAnnotationFailure() throws IOException, IllegalAccessException, InstantiationException {
    ...
    GroovyClassLoader gcl = new GroovyClassLoader(this.getClass().getClassLoader());
    Class scriptClass = gcl.parseClass(new File("src/test/groovy/BadTestScript.groovy"));
