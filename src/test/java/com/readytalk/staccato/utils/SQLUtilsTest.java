...
public class SQLUtilsTest extends BaseTest {
  ...
  public void testExecute() throws SQLException {
    ...
    ResultSet rs = SQLUtils.execute(makeConnection(), "select * from foo");
  ...
  public void testExecuteFile() throws MalformedURLException, SQLException {
    File file = new File("src/test/resources/test.sql");
    ResultSet rs = SQLUtils.executeSQLFile(makeConnection(), file.toURI().toURL());
